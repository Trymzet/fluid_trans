...
from models import Turnstile  # , Line
...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        topic_name = "com.udacity.transportation.arrivals"
        super().__init__(
            topic_name,
...
#         )
#         self.line = Line(color=color, station_data=station_data, num_trains=2)
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        value_details = {k: [v, type(v)] for (k, v) in value.items()}
